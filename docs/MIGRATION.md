...
1. [Firebase Console](https://console.firebase.google.com/) par ek naya project banayein.
2. **Authentication** enable karein (Email/Password aur Google).
...
```env
NEXT_PUBLIC_FIREBASE_API_KEY=aapki_key
NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN=aapka_domain
NEXT_PUBLIC_FIREBASE_PROJECT_ID=aapka_id
NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET=aapka_bucket
NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID=aapka_sender_id
NEXT_PUBLIC_FIREBASE_APP_ID=aapka_app_id
```
...
---
**Note:** Dashboard ka option tabhi dikhega jab aap login karenge aur aapka role 'business' hoga.
